...
// String def.
String data_out_one = "IR=";
String data_out_two = "irValue";
//heart_rate_data[2] = ",BPM=";
//heart_rate_data[3] = "beatsPerMinute";
//heart_rate_data[4] = ", Avg BPM=";
//heart_rate_data[5] = "beatAvg";
...
void loop() {
  ...
  if (checkForBeat(irValue) == true)
  {
    ...
    Serial.println(data_out_one + data_out_two);
